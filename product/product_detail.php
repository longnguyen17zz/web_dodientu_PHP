...
<body>
    ...
    <div class="product_detail">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<input type="hidden" name="stock" id="stock" value="' . $row['stock'] . '">';
            ...
            echo '<button id="add-to-cart" method="submit" class="add-to-cart" name="add-to-cart"><i class="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng</button>';
...
<script>
    ...
    function inc() {
        var count = document.getElementById('count');
        var stock = document.getElementById('stock').value;
        if (parseInt(count.value) < parseInt(stock)) {
            count.value = parseInt(count.value) + 1;
        }
    }
</script>
